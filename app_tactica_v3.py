...
# 🎞️ Cargar animación de radar futbolístico
def cargar_lottie_url = "https://assets10.lottiefiles.com/packages/lf20_3vbOcw.json"

    return None

lottie_url = "https://assets3.lottiefiles.com/packages/lf20_x62chJ.json"  # Radar futbolístico
animacion = cargar_lottie(lottie_url)
if animacion:
    st_lottie(animacion, height=180, key="inicio")
